...
# AppDigitalBank
En el presente repositorio se crea con el propósito para subir el codigo fuente de la aplicación web AppDigitalBank, Los servcios monitoreoService.Api y WcfServiceUsuario con la siguiente estructura.
